...
#STOP: Before you run this whole chunk, run line 115 JUST ONCE, then "#" it out. This is the easiest way to create the correctly formatted topDEgene object
```{r, include=FALSE}
setwd("D:/Zach Wolfe's DESeq analysis")
...
# topDEgene <- as.data.frame(totaldata[1,], row.names = comparison, col.names = c("V1", "log2FoldChange", "padj")) # run through this line in the chunk JUST ONCE, then "#" out this row. This is how we create the correctly formatted original topDEgene object
