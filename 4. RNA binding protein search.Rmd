...
#STOP: Before you run this whole chunk, run line 121 JUST ONCE, then "#" it out. This is the easiest way to create the correctly formatted topDEgene object
```{r, include=FALSE}
setwd("D:/Zach Wolfe's DESeq analysis")
...
# Get rid of the first row in topDEgene (created in line 119):
```{r}
