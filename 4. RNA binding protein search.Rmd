...
# Save as .csv:
```{r}
write.csv(topDERBP[1641:6560,], file = "topDifferentiallyExpressedRBPsbyComparison.csv")
...
write.csv(as.character(rownames(logSums)), file = "RBP log2foldchange list (AFD).csv")
```
