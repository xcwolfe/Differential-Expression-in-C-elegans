...
# It's because normalized_counts is just the counts data. In order to get this dataframe, we NEED a DESeq dataset, not just counts data. Unfortunately, you can't do a rep x rep DESeq, they disabled this ability 2 versions ago.
# Maybe try to do type x type DESeq, but ensure that normalized counts are somehow integrated?
```{r}
